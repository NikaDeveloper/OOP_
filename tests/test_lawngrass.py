...
def test_add_lawngrass():
    grass1 = LawnGrass(
        name="Grass 1", description="Premium", price=500, quantity=10,
        country="Russia", germination_period="7 days", color="Green"
    )
    grass2 = LawnGrass(
        name="Grass 2", description="Standard", price=400, quantity=15,
...
def test_add_different_classes_raises_error():
    smartphone = Smartphone(
        name="iPhone", description="", price=1000, quantity=1,
        efficiency=0, model="", memory=0, color=""
    )
    grass = LawnGrass(
        name="Grass", description="", price=100, quantity=1,
